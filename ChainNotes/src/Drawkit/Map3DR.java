...
public class Map3DR extends JPanel
{
	...
	public Map3DR(int PointInit, int pointsPerLine, int pointTotal)
	{
		/* necessary for label rotation */
		if (offFrame == null)
		{
	...
	public void paintComponent(Graphics g)
	{
		...
		*/
		...
		/* draw separator lines to divide the page into three rows */
		...
		for (rowIndex=0; rowIndex<3; rowIndex++)
		{
			...
			if (pointRemain > 0)
			{
				...
				for (x = 0; x < pointsPerLine2; x++)
				{
					...
					g2.drawImage(dotImg, pointX, pointY - 1, this);
	...
	public Image createDot(Color bg, Color fg)
	{
		...
		/* array to store one pixel per element */
		int[] dotMap;

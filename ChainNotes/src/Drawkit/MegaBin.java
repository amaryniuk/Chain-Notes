...
public class MegaBin extends JPanel
{
...
// --Recycle Bin STOP (7/10/03 3:27 PM)
	...
	public MegaBin(int PointInit, int pointsPerLine, int pointTotal, int shotPointSpacing, int receiverInterval, int pointType)
	{
		...
		setPreferredSize(new Dimension(1015, 450));
	}
	...
	public void paintComponent(Graphics g)
	{
		...
		*/
		...
		for (rowIndex=0; rowIndex<3; rowIndex++)
		{
			...
			/* initialize to right-end of mapped line */
			...
			if (pointRemain > 0)
			{
				...
				for (x = 0; x < pointsPerLine2; x++)
				{
					if (pointType2 % pointSet == 0)
					{
						...
						g2.drawImage(labelImg, pointX - 8, pointY + 10, this);
					}
					else
					{
	...
	public Image createFlag(Color bg, Color fg)
	{
		...
		/* create array to hold one pixel per element */
...
//		int height = 15;
//
//		/* array to store dot Image information */
//		int[] dotMap;
